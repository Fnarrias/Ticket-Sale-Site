            ...
            <Grid>
                <Paper elevation={5} style={paperStyle}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <TextField name='email' id='email' style={textFieldStyle} variant="standard" label='Correo' placeholder='Ingrese su correo' fullWidth required/>
                        <TextField name='password'id='password' style={textFieldStyle} variant="standard" label='Contraseña' placeholder='Ingrese su contraseña' type='password' fullWidth required/>
                        <Button style={buttonStyle} type='submit' variant="outlined" fullWidth sx={{color:'#d83f87', borderColor:'#d83f87'}} >Iniciar sesión</Button>
                    </form>
                    <Typography style={typographyStyle} fullWidth>¿No tienes cuenta? <Link href='#'>Regístrate</Link></Typography>
                </Paper>
            </Grid>
        </>
    );
